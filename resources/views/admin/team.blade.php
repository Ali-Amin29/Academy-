    ...
    <div class="container" id="form">
        <div class="container mt-3">
            ...
            <form action="{{ route('three') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-sm-4">
                    <input type="file" class="form-control" placeholder="Enter photo" name="photo3">
                </div>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" placeholder="Enter name games" name="name3">
                    </div>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" placeholder="Enter descrption" name="descrption3">
                    </div>
