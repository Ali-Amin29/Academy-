...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('dashbord/dist/img/AdminLTELogo.png') }}" alt="AdminLTELogo" height="90" width="90">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
     ...
     <a href="index3.html" class="brand-link">
       <img src="{{ asset('dashbord/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
     ...
     <div class="sidebar">
       ...
       <div class="user-panel mt-3 pb-3 mb-3 d-flex">
         <div class="image">
           <img src="{{ asset('dashbord/dist/img/user2-160x160.jpg') }}" class="img-circle elevation-2" alt="User Image">
         </div>
         <div class="info">
       ...
       <nav class="mt-2">
         <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
           <!-- Add icons to the links using the .nav-icon class
                ...
                @if(Auth::user()->state == "acadamy" || Auth::user()->state == "coach" )
...
<br>
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <br>
               <li class="nav-item">
                <form action="{{route('super_send_massage',Auth::user()->id)}}" method="get">
         <button class="btn btn-primary" style="display: block;width:100%;">
          <i class="fa-solid fa-pen-to-square"></i> <p style="display: inline-block;margin-right:98px">massage</p> 
...
@if(Auth::user()->state == "super" )
       ...
       <a href="" class="nav-link active">
        <i class="fa-solid fa-people-group"></i> 
         ...
         <ul class="nav nav-treeview">
           <li class="nav-item">
             <a href="{{ route('super_index') }}" class="nav-link active">
               <i class="far fa-circle nav-icon"></i>
               <p> All </p>
             </a>
           </li>
